    ...
    >
      ...
      {showClearIcon ? (
        ...
        <Icon
          ...
          className="absolute right-0 items-center group-hover:text-primary-400"
        />
      )}

      {isOpen && (
        <ul
          className="scrollbar absolute top-[44px] z-20 flex max-h-[160px]
         w-full animate-flip-down flex-col gap-1 overflow-auto border
